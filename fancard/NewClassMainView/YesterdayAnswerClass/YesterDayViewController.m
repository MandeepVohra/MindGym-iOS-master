...
//  fancard
//
//  Created by Mandeep on 02/02/16.
...
@interface YesterDayViewController ()<PagedFlowViewDelegate, PagedFlowViewDataSource>{
    UIView *_titleView;
    UIButton *_vsRandom;
    UIButton *_vsFriend;
    UIButton *_vsBack;
...
//    //[self.view addSubview:_titleView];
    ...
    [viewHeader setBackgroundColor:[UIColor colorWithRed:44.0/255.0 green:151.0/255.0 blue:223.0/255.0 alpha:1.0]];
    [self.view addSubview:viewHeader];
    
    _vsBack = [UIFactory createButtonWithFrame:CGRectMake(5, 10, 44, 30)
                                            Target:self
                                          Selector:@selector(BackButton)
                                             Image:@"Btn_back"
                                      ImagePressed:@"Btn_back"];
    [viewHeader addSubview:_vsBack];
    ...
    [viewHeader addSubview:_vsFriend];
    ...
    [viewHeader addSubview:_vsRandom];
